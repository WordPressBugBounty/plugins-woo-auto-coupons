...
== Changelog ==
= 3.1.0  = * Fix AJAX output compatibility. Added customizable removed-coupon notification.
...
= 3.0.43 = * Minor php warning fixes
= 3.0.42 = * Fallback when customer declines cookies
...
= 3.0.36 = * Compatibility with WC 10.1
= 3.0.35 = * Update refresh behavior
= 3.0.33 = * Minor optimization to coupon query
